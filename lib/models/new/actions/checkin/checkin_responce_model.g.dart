...
part of 'checkin_responce_model.dart';

// **************************************************************************
// JsonSerializableGenerator
// **************************************************************************

CheckInSubmitResponseModel _$CheckInSubmitResponseModelFromJson(Map<String, dynamic> json) => CheckInSubmitResponseModel(
      status: json['status'] as String?,
      message: json['message'] as String?,
      data:json['data'] == null ? null :  _$DataFromJson(json['data'] as Map<String, dynamic>),
    );

// Map<String, dynamic> _$CheckInSubmitResponseModelToJson(CheckInSubmitResponseModel instance) => <String, dynamic>{
...
Data _$DataFromJson(Map<String, dynamic> json) => Data(
      ...
      ticketInfo: _$TicketInfoFromJson(json['ticket_info'] as Map<String, dynamic>),
    );
