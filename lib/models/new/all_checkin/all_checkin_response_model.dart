...
part 'all_checkin_response_model.g.dart';

@JsonSerializable()
class AllCheckInResponse {
  AllCheckInResponse({required this.status, required this.message, required this.data});

  factory AllCheckInResponse.fromJson(Map<String, dynamic> json) => _$AllCheckInResponseFromJson(json);
...
class Data {
  ...
  final List<CheckinList> checkinList;
}
