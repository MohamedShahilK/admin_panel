...
class MasterReportBloc {
  ...
  final getAllCheckInItemsStream = BehaviorSubject<ActionsResponseModel?>();
    ...
    final getAllTicketsWthoutPageNoRespStream = BehaviorSubject<GetAllTicketsResponse?>();
  ...
  //     return null;  final getAllTicketsWthoutPageNoRespStream = BehaviorSubject<GetAllTicketsResponse?>();
  ...
  // }
    ...
    Future.delayed(const Duration(milliseconds: 500), () {
      getAllTicketsWthoutPageNoRespStream.add(respModel);
    });
