...
ValueNotifier<int> currentPageForMasterReportPage = ValueNotifier(1);

class MasterReportPage extends StatefulWidget {
  const MasterReportPage({
    super.key,
  });

  @override
  State<MasterReportPage> createState() => _MasterReportPageState();
}

class _MasterReportPageState extends State<MasterReportPage> with WidgetsBindingObserver {
                                                  ...
                                                  ...List.generate(allTickets?.data?.totalPages ?? 0, (index) {
                                                    return Padding(
                                                      ...
                                                      child: ValueListenableBuilder(
                                                        valueListenable: currentPageForMasterReportPage,
                                                        builder: (context, ix, _) {
                                                          return Container(
                                                            height: 22,
                                                            width: 22,
                                                            decoration: BoxDecoration(
                                                              color: index + 1 != currentPageForMasterReportPage.value ? Colors.grey : Colors.purple[400],
                                                            ...
                                                            child: InkWell(
                                                              onTap: () async {
                                                                ...
                                                                currentPageForMasterReportPage.value = index + 1;
                                                                currentPageForMasterReportPage.notifyListeners();
                                                                        ...
                                                                        child: InkWell(
                                                                          onTap: () async {
                                                                            ...
                                                                            if (isSearchListAlongWithSearchKey) {
                                                                              ...
                                                                              currentPageForMasterReportPage.value = 1;
                                                                              currentPageForMasterReportPage.notifyListeners();
